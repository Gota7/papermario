...
/* 4203C 80066C3C 3C01800B */  lui       $at, %hi(retrace)
/* 42040 80066C40 A422F910 */  sh        $v0, %lo(retrace)($at)
...
/* 42050 80066C50 3C01800B */  lui       $at, %hi(retrace)
/* 42054 80066C54 A422F910 */  sh        $v0, %lo(retrace)($at)
.L80066C58:
...
/* 4209C 80066C9C 3C02800B */  lui       $v0, %hi(retrace)
/* 420A0 80066CA0 9442F910 */  lhu       $v0, %lo(retrace)($v0)
/* 420A4 80066CA4 2442FFFF */  addiu     $v0, $v0, -1
/* 420A8 80066CA8 3C01800B */  lui       $at, %hi(retrace)
/* 420AC 80066CAC A422F910 */  sh        $v0, %lo(retrace)($at)
...
/* 420E0 80066CE0 3C01800B */  lui       $at, %hi(retrace)
/* 420E4 80066CE4 A422F910 */  sh        $v0, %lo(retrace)($at)
.L80066CE8:
...
/* 4211C 80066D1C 3C01800A */  lui       $at, %hi(__osCurrentTime)
/* 42120 80066D20 AC23A60C */  sw        $v1, %lo(__osCurrentTime)($at)
.L80066D24:
...
/* 42144 80066D44 3C03800A */  lui       $v1, %hi(__osCurrentTime)
/* 42148 80066D48 8C63A60C */  lw        $v1, %lo(__osCurrentTime)($v1)
...
/* 4216C 80066D6C 3C01800A */  lui       $at, %hi(__osCurrentTime)
/* 42170 80066D70 08019B19 */  j         .L80066C64
/* 42174 80066D74 AC23A60C */   sw       $v1, %lo(__osCurrentTime)($at)
.L80066D78:
